...
SLCM_BROWSER_SCREEN_WIDTH = int(os.environ.get("SLCM_BROWSER_SCREEN_WIDTH", "430"))
SLCM_BROWSER_SCREEN_HEIGHT = int(os.environ.get("SLCM_BROWSER_SCREEN_HEIGHT", "932"))
